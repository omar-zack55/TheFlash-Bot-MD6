...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE 𝐅𝐋𝐀𝐒𝐇 𝐁𝐎𝐓 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR 𝐅𝐋𝐀𝐒𝐇 𝐁𝐎𝐓 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '𝐅𝐋𝐀𝐒𝐇﹝⚡️﹞𝐁𝐎𝐓'} 
...
const eFlashCoins = () => { return '🐱 FlashCoins' }
const eFlashTickers = () => { return '🎫 Flash Tickets' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar 𝐅𝐋𝐀𝐒𝐇 𝐁𝐎𝐓`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar 𝐅𝐋𝐀𝐒𝐇 𝐁𝐎𝐓 en Grupos`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝐅𝐋𝐀𝐒𝐇 𝐁𝐎𝐓!!! 😸\n\n💖 𝐅𝐋𝐀𝐒𝐇 𝐁𝐎𝐓 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n@${user}`}
...
const smsJBInfo2 = () => { return `💖 *La función es estable, sí presenta algún inconveniente Comuníquese al correo: yto941395@gmail.com*\n💝 *Puede hacer una Donación voluntaria por PayPal: ${global.paypal}*\n\n*Muchas Gracias por el apoyo a ${global.packname}*`}
...
const smsContacto4 = () => { return 'Contacto Oficial de 𝐅𝐋𝐀𝐒𝐇 𝐁𝐎𝐓 🐈'}
